## Dataset
This repo has a paired chart image and table. The source of this dataset is [https://huggingface.co/datasets/chiragtubakad/chart-to-table](https://huggingface.co/datasets/chiragtubakad/chart-to-table).
